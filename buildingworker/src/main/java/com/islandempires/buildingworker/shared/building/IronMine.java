...
public class IronMine extends RawMaterialProductionStructures implements Serializable {
    ...
    public void islandBuildingLevelUpExecution(int nextLvl, String islandId) {
        ...
        try {
            ...
            increaseOrDecreaseIslandResourceFieldDTO.setIslandResourceEnum(IslandResourceEnum.IRON_HOURLY_PRODUCTION);

            int increaseOrDecreaseValue = (nextLvl > 1) ? ironMineLevelList.get(nextLvl - 1).getHourlyIronProduction() - ironMineLevelList.get(nextLvl - 2).getHourlyIronProduction() :
                    ironMineLevelList.get(nextLvl - 1).getHourlyIronProduction();
