...
public class Fisher extends FoodProductionStructures implements Serializable {
    ...
    public void islandBuildingLevelUpExecution(int nextLvl, String islandId) {
        ...
        try {
            ...
            increaseOrDecreaseIslandResourceFieldDTO.setIslandResourceEnum(IslandResourceEnum.FISH_HOURLY_PRODUCTION);

            int increaseOrDecreaseValue = (nextLvl > 1) ? fisherLevelList.get(nextLvl - 1).getHourlyFishProduction() - fisherLevelList.get(nextLvl - 2).getHourlyFishProduction() :
                    fisherLevelList.get(nextLvl - 1).getHourlyFishProduction();
